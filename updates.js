 ...
 */
window.UPDATES = [
  { date: "2026-09-25", tag: "蒸留ノート", text: "ボタニカルごとの蒸留とブレンドの試作を記録する「蒸留ノート」を追加しました。素材の割合や加水量を計算し、香りの構成はボタニカル表の成分から確認できます。" },
  { date: "2026-09-07", tag: "カクテル技法", text: "17の技法と20名のバーテンダーの実践を収録した技法ガイドを追加しました。カクテル別の使い分けや比較結果も、その場で参照できます。" },
  { date: "2026-08-17", tag: "勤怠管理", text: "スタッフのシフト希望登録・確定と、月ごとの給与計算（深夜割増つき）ができる「勤怠管理」を新設しました。名前を選ぶだけで使え、給料はオーナーだけが暗証番号で確認できます。" },
  { date: "2026-06-22", tag: "ボタニカル表", text: "ジンのボタニカルと香気成分を検索・比較できる「ボタニカル表」を追加しました。" },
  { date: "2026-06-15", tag: "在庫カタログ", text: "ジン在庫カタログで、アプリから銘柄の登録申請ができるようになりました。" },
  { date: "2026-06-15", tag: "TOP", text: "スマホで上部メニューを2段表示にし、横スクロールなしで全タブが見えるようにしました。" },
  { date: "2026-06-15", tag: "全ツール", text: "アプリが常に最新の状態で表示されるようにしました（古い画面が残りにくくなりました）。" },
  { date: "2026-06-15", tag: "全ツール", text: "全ツールのアプリアイコンを、共通のロゴ（カクテルグラス）に統一しました。" },
  { date: "2026-06-15", tag: "投稿メーカー", text: "毎日のLINE投稿文を、選ぶ・入れるだけで自動で作れる「営業投稿メーカー」を新設しました。言い回しは毎回変わるので、コピペしても文がかぶりません。" },
  { date: "2026-06-11", tag: "TOP", text: "上のメニューとツール一覧の並び順を揃え、トップを見やすく整えました。" },
  { date: "2026-06-11", tag: "ジン教本", text: "よりニッチな内容を深掘りした「研究編」を追加しました。" },
  { date: "2026-06-11", tag: "在庫カタログ", text: "画面デザインを見直し、さらに見やすくしました。" },
  { date: "2026-06-11", tag: "クイズ道場", text: "ボタニカルからジンを当てる新しい問題を追加しました（現在テスト運用中です）。" },
